...
import de.lolhens.minecraft.blockshifter.BlockshifterPlatform
import de.lolhens.minecraft.blockshifter.config.Config.Commented.CommentedValueEncoder
import de.lolhens.minecraft.blockshifter.config.Config.{Commented, configPath}
import io.circe.*
...
object Config {
  def configDirectory: Path = BlockshifterPlatform.current.configDir
